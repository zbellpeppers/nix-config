{...}: {
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-24639726-03c9-4865-971d-76776a7be3d1" = [];
      "ActivityManager"."switch-to-activity-3d52bd52-5b8d-49be-a64d-bac7ae243e09" = [];
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput/1133/50504/Logitech USB Receiver Mouse"."PointerAcceleration" = 0.120;
